...
echo "  • Scenarios    : Click buttons or press [1]-[4] (Urban, Thermal, Flood, EW)"
echo "  • EW Jamming   : Click [J] JAMMER button or press [J] to toggle -18dB Jamming"
echo "  • Modality     : Click [M] MODALITY button or press [M] (VisDrone Optical <-> HIT-UAV FLIR)"
echo "  • UAV Distance : Drag slider, click [+/- 100m], or use [UP]/[DOWN] arrow keys"
