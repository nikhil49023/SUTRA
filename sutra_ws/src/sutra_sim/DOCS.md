...
> **Dependencies:** Gazebo Sim 8 (Harmonic/Jazzy), `ros_gz_bridge`, SDFormat 14.0, NS-3.38 C++ Simulator
...
1. **Gazebo Sim 8 SITL World** (`real_world_digital_twin_swarm.sdf`):
...
2. **UAV Swarm SITL Models** (`models/uav_alpha_lead.sdf`, `models/uav_beta_relay.sdf`):
   ...
   - Dual Camera Rig: RGB Optical ($1920 \times 1080 @ 30\text{ Hz}$) + LWIR Thermal Infrared ($640 \times 480 @ 30\text{ Hz}$).
...
├── worlds/
│   └── real_world_digital_twin_swarm.sdf # Gazebo Sim 8 SITL Disaster World (SDF 14.0)
├── models/
