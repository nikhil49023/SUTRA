...
COMMAND_PERMISSION_MATRIX: Dict[str, Permission] = {
    ...
    "mission.restart": Permission.MISSION_EXECUTE,
    ...
    "mission.set_waypoints": Permission.MISSION_EDIT,
    "MISSION_SET_WAYPOINTS": Permission.MISSION_EDIT,
    ...
    "geofence.update": Permission.GEOFENCE_EDIT,
    "GEOFENCE_UPDATE": Permission.GEOFENCE_EDIT,
    "geofence.select": Permission.GEOFENCE_READ,
    "GEOFENCE_SELECT": Permission.GEOFENCE_READ,
