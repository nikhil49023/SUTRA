...
# Target template to read and overwrite
TEMPLATE_FILE = "/Users/Harika/Downloads/Smart-Horizon-2026-48Hour-Intrnl Hackathon Grand Finale Template (1).pptx"
...
COLOR_HEADER = RGBColor(14, 116, 144)     # Deep Cyan / Teal Blue
...
def set_content_box(slide, bullets, top=Inches(1.18), height=Inches(3.82)):
    ...
    for item in bullets:
        ...
        p.space_after = Pt(item.get("space_after", 4.0))
...
for sp in s1.shapes:
    if sp.name == "Text 13" and "Title:" in sp.text_frame.text:
        ...
        r1.font.name = "Times New Roman"
        r1.font.size = Pt(13)
        r1.font.color.rgb = COLOR_HEADER
        r2 = p.add_run()
...
s2_bullets = [
    {
        ...
        "text": "In catastrophic flash floods and landslides (e.g., Kedarnath, Wayanad), the initial 72-hour window dictates survival. Unstable debris, destroyed bridges, and toxic floodwaters make manual foot search dangerously slow and life-threatening for ground responders.",
    ...
    },
    {
        ...
        "text": "Commercial drones rely on digital 2.4/5.8 GHz Wi-Fi and H.264 video. When signal-to-noise ratio drops below 5 dB due to rain, dense foliage, or jamming, digital video drops off a cliff—causing catastrophic frame freezing and black screens.",
        "size": 11, "space_after": 4
    },
    {
...
# ==========================================
# SLIDE 11: Screenshots (Live Captures)
# ==========================================
s11 = prs.slides[10]
...
# Update dates on all slides to 03 September 2026
for slide in prs.slides:
    for sp in slide.shapes:
        if sp.has_text_frame and "31 August 2026" in sp.text_frame.text:
            sp.text_frame.text = sp.text_frame.text.replace("31 August 2026", "03 September 2026")

# Save directly to ALL destinations
